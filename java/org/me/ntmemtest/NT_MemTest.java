...
public class NT_MemTest extends Activity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        showEditText = sharedPrefs.getBoolean("show_edittext", true);
        reverseMode = sharedPrefs.getBoolean("reverseMode", false);
        ...
        //gestureOverlayView.setGestureColor(textColor);
        ...
        final Button btnAddVerse = (Button) findViewById(R.id.btnAddVerse);
        ...
        final Button btnAddChapter = (Button) findViewById(R.id.btnAddChapter);
        ...
        //ll00.setLayoutParams(new LinearLayout.LayoutParams(params0));
        ...
        getSaveVerse();
        //int versecolumncount = myDbHelper.upgradeTable();
 ...
 // Handler on the main (UI) thread that will receive messages from the 
        ...
        public void handleMessage(Message msg) {
            ...
            if (total <= 0){
                ...
                if (countAdd == 0 && chapterCancel){
                	//Toast.makeText(NT_MemTest.this, sumArray(chap_length), Toast.LENGTH_SHORT).show();
                	//int totaly = sumArray(chap_length);
                	chapterCancel = false;
                    chapterScope = true;
                    builder.show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.quit:
            //moveTaskToBack(true);
            startActivity(new Intent(this, SearchBible.class));
            //System.exit(0);
        ...
        case R.id.info:
            ...
            infotext = "Gestures:" + '\n' +
                    ...
                    "Tap the verse reference to display verse text." + '\n' + '\n' + dispStats();
            //Toast.makeText(NT_MemTest.this, infotext, Toast.LENGTH_LONG).show();
        ...
        case R.id.share:
            ...
            //Toast.makeText(NT_MemTest.this, "Not yet implemented.", Toast.LENGTH_SHORT).show();
            break;
        case R.id.settings:
        ...
        case R.id.backup:
            ...
            //startActivity(new Intent(NT_MemTest.this, ManageDB.class));
            //Toast.makeText(NT_MemTest.this,dispStats(),Toast.LENGTH_LONG).show();
            //Toast.makeText(NT_MemTest.this, "Not yet implemented.", Toast.LENGTH_SHORT).show();
            break;
        default:
            break;
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
      ...
      //String MyBook = savedInstanceState.getString("MyBook");
      //int MyChapter = savedInstanceState.getInt("MyChapter");
      //int MyVerse = savedInstanceState.getInt("MyVerse");
      //String MyAuto = savedInstanceState.getString("MyAuto");
      //String MyVersion = savedInstanceState.getString("MyVersion");
    ...
    public void checkVerse(){
        ...
        //this.tbOutput.setText(verseText);
        String text1 = "";
        String text2 = "";
        String wordScore = "";
        String orderScore = "";
    ...
    public void nxtMyVerse(){
        try{
            ...
            if (cntVerseList > 0){
                ...
                //myDbHelper.queryVerseById(number2, version);
                ...
                //chapter = myDbHelper.queryChapter;
                spinner2.setSelection(chapter-1);
                updChapter();
                verse = Integer.valueOf(tempVerses[2][number1]);
                //verse = myDbHelper.queryVerse;
                spinner3.setSelection(verse - 1);
            }else{
    ...
    public void flashBack(boolean noChange){
        ...
        if (orient == 2){
            ...
            if (flashStyle){
                ...
                //editlayout.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT,
                ...
                /*ll01.setLayoutParams(new LinearLayout.LayoutParams(px480, px50));
                ll02.setLayoutParams(new LinearLayout.LayoutParams(px480, px50));
                tvBlank01.setLayoutParams(new LinearLayout.LayoutParams(px480, px12));
                editlayout.setLayoutParams(new LinearLayout.LayoutParams(px480, px67));
                ll03.setLayoutParams(new LinearLayout.LayoutParams(px480, px12));
                llVerse.setLayoutParams(new LinearLayout.LayoutParams(px480, px157));*/
                //ll04.setLayoutParams(new LinearLayout.LayoutParams(px320, px36));
                ...
                ll03.setLayoutParams(new LinearLayout.LayoutParams(params5));
                llVerse.setLayoutParams(new LinearLayout.LayoutParams(params6));
                /*ll01.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                ll02.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                tvBlank01.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                editlayout.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                ll03.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                llVerse.setLayoutParams(new LinearLayout.LayoutParams(px480, px320));*/
                //ll04.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
            }
        }else{
            if (flashStyle){
                //convert back to normal
                ...
                ll03.setLayoutParams(new LinearLayout.LayoutParams(params5));
                llVerse.setLayoutParams(new LinearLayout.LayoutParams(params6));
                /*ll01.setLayoutParams(new LinearLayout.LayoutParams(px320, px50));
                ll02.setLayoutParams(new LinearLayout.LayoutParams(px320, px50));
                tvBlank01.setLayoutParams(new LinearLayout.LayoutParams(px320, px12));
                editlayout.setLayoutParams(new LinearLayout.LayoutParams(px320, px100));
                ll03.setLayoutParams(new LinearLayout.LayoutParams(px320, px36));
                llVerse.setLayoutParams(new LinearLayout.LayoutParams(px320, px200));*/
                //ll04.setLayoutParams(new LinearLayout.LayoutParams(px320, px36));
                ...
                editlayout.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                ll03.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                llVerse.setLayoutParams(new LinearLayout.LayoutParams(px320, px480));*/
                //ll04.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
            }
        }
        flashStyle = !flashStyle;
        ...
        if (orient == 2){
            if (showEditText){
                ...
                if (!flashStyle){
                    ...
                    llVerse.setLayoutParams(new LinearLayout.LayoutParams(params1));
                    //editlayout.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                    //llVerse.setLayoutParams(new LinearLayout.LayoutParams(px480, px157 + px67));
                }
            }
        }else{
            if (showEditText){
                ...
                if (!flashStyle){
                    ...
                    //editlayout.setLayoutParams(new LinearLayout.LayoutParams(0, 0));
                    //llVerse.setLayoutParams(new LinearLayout.LayoutParams(px320, px200 + px100));
                }
            }
        }
    }
    ...
    public void updPrefs(){
        ...
        auto = myDbHelper.saveAuto;
        preview = myDbHelper.saveHint;
        //version = myDbHelper.saveVersion;  now handled under getSaveVerse();
        checkbox.setChecked(preview);
        getSaveVerse();
        toggleEditLayout();
        updColors();
